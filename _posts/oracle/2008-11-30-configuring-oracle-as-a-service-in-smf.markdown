...
wordpress_url: http://posulliv.com/?p=38
---
...
means, it's just a short post on how to get it working. For more information on SMF and Solaris 10 in general, have a look through Sun's excellent online documentation at <a href="http://docs.sun.com/">http://docs.sun.com</a>.

<span style="font-weight: bold;">Adding Oracle as a Service</span>
...
installing ora-smf is available from <a href="http://joostm.nl/solaris/smf/ora-smf/ora-smf-1.5.pkg">here</a>.
...
<span style="font-weight: bold;">Testing Out SMF</span>
