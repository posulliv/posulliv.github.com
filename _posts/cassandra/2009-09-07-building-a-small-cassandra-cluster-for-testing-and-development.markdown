...
export PATH=$CASSANDRA_PATH:$PATH</pre>
...
$ git clone git://git.apache.org/cassandra.git latest</pre>
...
<pre>$ cp -R $CASSANDRA_HOME/conf/* $CASSANDRA_CONF
...
DEBUG - CHANGE IN STATE FOR 192.168.221.138:7001 - has token 65882889577194449649405650603559126735</pre>
